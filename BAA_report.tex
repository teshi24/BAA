...
%		\end{comment}	
	\chapter{Methods}\label{chap:methodology}
		...
		Libraries such as \texttt{Fairlearn} are used for bias detection and mitigation. \todo{consolidate formatting - consider replacing textit with texttt or vise versa}
		...
		Before starting any evaluation, the PASSION experiments must be reproduced on the \gls{gpuhub}, to ensure, that the code base and the data loading is working the same way as for the initial paper. Only then, the evaluation outcome can be used by the PASSION team.
		...
		\todo{add more details? Or in explain the detailed approach with Equalized Odds in a seperate (sub-?)chapter? for sure, bring fairlearn into it}
		...
		This approach ensures that the final test results are comparable across different methods, while keeping the selection process independent of the test data. It follows standard machine learning methodology to prevent overfitting to the test set.\todo{cite AI lectures or textbook, e.g., Goodfellow et al., 2016
	...
	\chapter{writing ongoing TODO REMOVE THIS CHAPTER}\todo{remove this chapter}
		...
		\todo{consider this: 
			...
			\todo{maybe include more regarding passion dataset or model based on https://chatgpt.com/c/683412cd-5fa0-8007-8369-7bc9e41ac6ba}
			\todo{write things to consider more precisely:}
			\begin{itemize}
