...
\begin{document}
	...
	\chapter{State of Research}
		...
		This chapter provides an overview over biases and related features which were mentioned in ML and dermatology related research.
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\tblWidthDescription}X|>{\tblWidthContext}X|>{\tblWidthContext}X}
						...
						\multicolumn{3}{l}{\bolditalic{Representation Biases}} \\
						Representation Bias  & X\tnote{1,2,15,20} & X\tnote{21} \\
						Aggregation Bias     & X\tnote{1,2} &   \\
									
						\multicolumn{3}{l}{\bolditalic{Measurement Biases}} \\
					...
					\begin{tablenotes}
						...
						\begin{minipage}{0.33\textwidth}\raggedright
							...
							\item[14] \autocite{Delgado-Rodríguez_2004}
			...
			\paragraph{Feature Representation Biases \autocite{Chakraborty_2024}}
			...
			\paragraph{Imaging Biases \autocite{Young_2020}}
			...
			\paragraph{Medical Biases \autocite{Chakraborty_2024}}
