...
\begin{document}
	...
	\chapter{State of Research}
			...
			\subsection{Mitigation Methods Overview}
				\begin{comment}
					\begin{table}[H]
						...
						\begin{threeparttable}
								\begin{tabularx}{\textwidth}{>{\hsize=0.5\hsize\raggedright}X|>{\hsize=0.1\hsize}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
										\toprule
										\textbf{Mitigation Methods} & \multicolumn{3}{c}{\textbf{Mentioned in Context of}} \\
										& \textbf{ML} & \textbf{Dermatology} & \textbf{Demography in Dermatology} \\
										%	\midrule
										\multicolumn{4}{l}{\textbf{Pre-processing}} \\ 
										Community Detection & X\tnote{1,2} &  &   \\
										Word Embedding & X\tnote{1,3} &  &   \\
										Optimized Pre-processing & X\tnote{1,4} &  &   \\
										Data Pre-processing & X\tnote{1,5} &  &   \\
										%	\midrule
										\multicolumn{4}{l}{\textbf{In-processing}} \\ 
										Classification    & X\tnote{1,6,7,8} &  &   \\
										Regression    & X\tnote{1,9} &  &   \\
										%	\midrule
										\multicolumn{4}{l}{\textbf{Post-processing}} \\ 
										Adversarial Learning    & X\tnote{1,10} &  &   \\
										Classification \todo{fix footnotes from here} & X\tnote{1,63,125,102} & & \\
										Word Embedding & X\tnote{1,20} & & \\
										\bottomrule
									\end{tabularx}
								\begin{tablenotes}
										\footnotesize
										\begin{minipage}{0.33\textwidth}\raggedright
												\item[1] \autocite{Mehrabi_2021}
												\item[2] \autocite{M104_}
												\item[3] \autocite{M23_}
												\item[4] \autocite{M27_}
												\item[5] \autocite{M76_}
												\item[6] \autocite{M159_}
												\item[7] \autocite{M78_}
												\item[8] \autocite{M155_}
												\item[9] \autocite{M14_}
												\item[10] \autocite{M90_}
											\end{minipage}%
										\begin{minipage}{0.33\textwidth}\raggedright
												%\item[5] \autocite{M87_Kusner_2017}
											\end{minipage}%
									...
									\end{tablenotes}
							\end{threeparttable}
						\caption{Mitigation Methods - Mentioned in Contextual Research, grouped like in \cite{Mehrabi_2021}, the author cannot guarantee for completeness}
						\label{tab:mitigation_methods_algorithms}
					\end{table}
				\end{comment}
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\hsize=0.5\hsize\raggedright}X|>{\hsize=0.1\hsize}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
						...
						& \textbf{ML} & \textbf{Dermatology} & \textbf{Demography in Dermatology} \\
						%	\midrule
						\multicolumn{4}{l}{\textbf{Fair Representations (Pre/In-processing \todo{check with Ludovic})}} \\ 
						Representation Learning by Disentanglement & X\tnote{1,2} &  &   \\
						Variational Fair Autoencoder & X\tnote{1,3} &  &   \\
						VAE without adversarial training & X\tnote{1,4} &  &   \\
						 & X\tnote{1,5} &  &   \\
						%	\midrule
						\multicolumn{4}{l}{\textbf{Fair Word-Embedding (Pre/In-processing) \todo{check with Ludovic}}} \\ 
						Fair Word-Embedding & X\tnote{1,5,6,7} &  &   \\
						Train-Time Data Augmentation & X\tnote{1,8} &  &   \\
						Test-Time Neutralization & X\tnote{1,8} &  &   \\
						%	\midrule
						\multicolumn{4}{l}{\textbf{Others}} \\ 
		...
		\subsection{Mitigation Methods Extensive Sources}
			...
			\todo{move on here to fill the mitigation methods table}
