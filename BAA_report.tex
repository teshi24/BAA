			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\hsize=0.5\hsize\raggedright}X|>{\hsize=0.1\hsize}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
						...
						Representation Bias  & X\tnote{1,2,15} &  &   \\
						Aggregation Bias     & X\tnote{1,2} &  &   \\
						Sampling Bias        & X\tnote{1} &  &   \\
						(Systematic) Selection Bias		 & X\tnote{18} & X\tnote{19,c5,c6,c33}  & \\
						...
						Diagnostic Access Bias & & X\tnote{19,c19,c20} & \\
						...
						Self-Selection Bias  & X\tnote{1,18} &  &   \\
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\hsize=0.4\hsize\raggedright}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
						...
						Skin Type & X\tnote{1,2,7} & & \\
						Gender/Sex & X\tnote{1,2,7,8,9,10,11} & & \\
						Gender and Skin Type Subgroups & X\tnote{1,2} & & \\
						Geographic Location & X\tnote{1,3} & & \\
						Ethnicity/Race \todo{check definitions} & X\tnote{1,2,4,5,6,7,11}& & \\
						Socio-Economic Status & X\tnote{6} & & \\
			...
			\subsection{Mitigation Methods Overview}
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\hsize=0.5\hsize\raggedright}X|>{\hsize=0.1\hsize}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
						...
						Allocation concealment and blinding & & \tnote{17} & \\
						Check confidence interval and p-curve analysis instead of p-value & & \tnote{17} & \\
						\bottomrule
					\end{tabularx}
					\begin{tablenotes}
						\footnotesize
