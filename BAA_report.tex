	...
	\chapter{State of Research}
		...
		This chapter provides an overview over biases and related features which were mentioned in ML and dermatology related research.
			...
			\subsubsection{Data Biases}
				...
				\paragraph{Representation Biases \autocite{Mehrabi_2021} \autocite{Chakraborty_2024}}
			...
			\paragraph{Clinical and Diagnostic Biases \autocite{Chakraborty_2024}}
			...
			\paragraph{Measurement Biases \autocite{Mehrabi_2021} \autocite{Chakraborty_2024} \autocite{Montoya_2025}}
			...
			\begin{itemize}
				...
				\item \textbf{Annotator bias}, the labeling process of human annotators can be influenced by lots of factors (e.g. personal background, social context) and even minor design choices (e.g. scale order, image context). This can introduce inconsistencies when labeling the data \autocite{Montoya_2025}
			\end{itemize}
			...
			\paragraph{Research Biases \autocite{Mehrabi_2021} \autocite{Chakraborty_2024} \todo{potentially an own category in front of data biases}}
			...
			\begin{itemize}		
				...
				\item  Industry sponsorship bias: This has now been reclassified as conflict-of-interest bias. In short, the study deliberately supports the findings expected from it by its sponsors. 22.\autocite{Chakraborty_2023} - dermatology
			...
			\paragraph{ Biases \autocite{Mehrabi_2021} \autocite{Chakraborty_2024}}
