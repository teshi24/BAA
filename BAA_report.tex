		...
		\section{General ML biases}
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					...
					%\begin{tabularx}{\textwidth}{>{\hsize=0.6\hsize\raggedright}X|>{\hsize=0.2\hsize}X|>{\hsize=0.2\hsize}X}
						\toprule
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\tblWidthDescription}X|>{\tblWidthContext}X|>{\tblWidthContext}X}
						...
						& \textbf{ML} & \textbf{Dermatology} \\
						%\midrule
						\multicolumn{3}{l}{\textbf{Affected Features}} \\
			...
			\subsection{Mitigation Methods Overview}
				...
				\begin{threeparttable}
						...
						Public Datasets & & X\tnote{18, \todo{add source}} \\
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\tblWidthDescription}X|>{\tblWidthContext}X|>{\tblWidthContext}X}
						...
						& \textbf{ML} & \textbf{Dermatology} \\
						%	\midrule
						\multicolumn{3}{l}{\textbf{satisfy certain fairness definitions}} \\ 
						...
						\multicolumn{3}{l}{\textbf{satisfy fairness definitions and stability for test set changes}} \\ 
						\todo{find out exact method} & X\tnote{1,11} &  \\
						\multicolumn{3}{l}{\textbf{Adaptions of existing classifiers}} \\ 
						Modified discrimination-free Naive Bayes classifier & X\tnote{1,12} &  \\
						\multicolumn{3}{l}{\textbf{Frameworks}} \\ 
						...
						\multicolumn{3}{l}{\textbf{Preferential Data Usage \todo{find better name}}} \\ 
						...
						\multicolumn{3}{l}{\textbf{Provide Interpretability}} \\ 
			...
			\todo{Representation Learning: relevant for BAA}
			\begin{table}[H]
				\centering
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\tblWidthDescription}X|>{\tblWidthContext}X|>{\tblWidthContext}X}
						...
						%	\midrule
						\multicolumn{3}{l}{\textbf{Others \todo{find other categorization}}} \\ 
