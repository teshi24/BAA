...
\begin{document}
	...
	\chapter{State of Research}
		...
		\section{Bias}
		The algorithmic decisions of \gls{AI} affect peoples' lives. Due to that, healthcare \gls{AI} applications, like PASSION, are sensitive tools. However, decisions from \gls{AI} applications proved to be biased, which can harm underrepresented groups. Therefore, \gls{AI} engineers should aim to address and mitigate those biases. To do so, it is crucial to know what bias is, what types of biases exist and where they are coming from \autocite{Mehrabi_2021}.
		This chapter provides therefore an overview over biases and related features which were mentioned in \gls{ML}- and dermatology-related research.
		...
		\subsection{Introduction to Bias in \gls{AI}}
		    In \gls{ML}, bias can be defined as \textit{a systematic error that causes a model or estimator to consistently deviate from the true value or relationship} \autocite{Delgado-Rodriguez_2004, Taylor_2023}.
