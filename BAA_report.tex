...
\begin{document}
	...
	\chapter{State of Research}
		...
		This chapter provides an overview over biases and related features which were mentioned in ML and dermatology related research.
			...
			\begin{table}[H]
				...
				\begin{threeparttable}
					\begin{tabularx}{\textwidth}{>{\tblWidthDescription}X|>{\tblWidthContext}X|>{\tblWidthContext}X}
						...
						\multicolumn{3}{l}{\bolditalic{Biases Stemming from User Interaction with the Algorithm}} \\
						User Interaction Bias& X\tnote{1,4} &    \\
						Presentation Bias    & X\tnote{1,4} &    \\
						Ranking Bias         & X\tnote{1,4,6} &    \\
						Emergent Bias        & X\tnote{1,9} &    \\
						
						\multicolumn{3}{l}{\bolditalic{Biases Stemming from Other External Influence}} \\
			...
			\paragraph{Biases Stemming from User Interaction with the Algorithm}
				\begin{itemize}
			...
			\paragraph{Biases Stemming from Other External Influence}
			...
			\begin{itemize}
				...
				\item  \textbf{Incorporation bias}. When index tests in diagnostic accuracy studies are part of the reference tests, this results in elevated sensitivity for the index tests \autocite{Chakraborty_2024, c21, c25, c26}.
