				...
				\begin{threeparttable}
					...
					\begin{tablenotes}
						...
						\begin{minipage}{0.49\textwidth} 
							...
							\item[2] [144] \autocite{M144_Suresh_2021}
							\item[3] [120] \autocite{M120_Olteanu_2019}
							\item[4] [9] \autocite{M9_Baeza-Yates_2018}
							\item[5] [44] \autocite{M44_Danks_2017}
							\item[6] [93] \autocite{M93_Lerman_2014}
							\item[7] [151] \autocite{M151_Wang_2014}
						\end{minipage}%
						\begin{minipage}{0.49\textwidth} 
							\item[8] [64] \autocite{M64_Hargittai_2007}
							\item[9] [53] \autocite{M53_Friedman_1996}
							\item[10] [117] \autocite{M117_Ciampaglia_2018}
							\item[11] [38, 131] \autocites{M38_Clarke_2005}{M131_Riegg_2008}
							\item[12] [24] \autocite{M24_Buolamwini_2018}
							\item[13] [114] \autocite{M114_Mustard_2003}
						\end{minipage}%
					\end{tablenotes}
				\end{threeparttable}
				\caption{Biases - Mentioned in Contextual Research, the author cannot guarantee for completeness}
